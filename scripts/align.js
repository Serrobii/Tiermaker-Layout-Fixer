(function() {
	...
	buttons.css("position", "fixed")
		   .css("margin",   "0px 0px 0px 0px")
		   .css("right",    `calc(100% - ${chartWidth} - 5px)`)
		   .css("top",      "115px");
	...
	altButton.css("position",     "fixed")
			 .css("width",        `calc(${chartWidth} - ${$ID("preview").clientWidth + "px"} - ${$ID("reset").clientWidth + "px"})`)
			 .css("left",         "5px")
			 .css("top",          "115px")
			 .css("marginTop",    "0px")
	...
	stillInLineStyle.innerHTML = `.still-in-list { position: relative; left: calc(${chartWidth} + 5px); bottom: 675px; }`;
